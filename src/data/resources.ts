...
export const categories: Array<{ id: ResourceCategory; label: string; description: string; count: number }> = [
  { id: 'documentation', label: 'Documentation', description: 'Complete guides to every Awwardly feature', count: 24 },
...
export const articles: Article[] = [
  {
    ...
    title: 'Getting Started with Awwardly',
    description: 'A complete walkthrough of setting up your first award program on Awwardly, from creating your hub to announcing winners.',
    cover: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&q=80&w=800',
    category: 'documentation',
    readingTime: '8 min read',
    difficulty: 'Beginner',
    author: 'Awwardly Team',
    ...
    content: [
      'Awwardly is the world\'s leading platform for award management, secure voting, and community recognition. This guide will walk you through everything you need to know to launch your first award program.',
      ...
      '## Step 3: Set Up Nomination Rules\n\nDefine who can nominate, what criteria nominees must meet, and the nomination window. Awwardly supports flexible rules including peer nominations, self-nominations, and committee selections.',
      '## Step 4: Configure Voting\n\nChoose between public voting, judge-only scoring, or a hybrid approach. Awwardly supports ranked choice, simple majority, and weighted scoring systems.',
      '## Step 5: Launch and Promote\n\nOnce everything is configured, publish your event and share it with your audience. Use Awwardly\'s built-in social features to maximize engagement.',
    ],
  },
  {
    ...
    content: [
      ...
      '## Create Urgency\n\nSet clear voting deadlines and countdown timers. Awwardly automatically displays remaining time to create urgency. Studies show that deadlines increase participation by 40%.',
      '## Leverage Social Proof\n\nShow real-time vote counts and trending nominees. When voters see others participating, they\'re more likely to join. Awwardly\'s live feed makes this seamless.',
      '## Multi-Channel Promotion\n\nDon\'t rely on a single channel. Use email, social media, SMS, and your website to remind voters. Awwardly provides shareable links and embeddable widgets.',
      '## Prevent Fraud\n\nAwwardly\'s anti-fraud system detects duplicate votes, bot activity, and suspicious patterns. Enable rate limiting and device fingerprinting for maximum security.',
  ...
  },
  {
    ...
    content: [
      'Award programs can be highly profitable when structured correctly. This blueprint covers every revenue stream available on Awwardly.',
      '## Paid Voting Campaigns\n\nOffer supporters the ability to cast premium votes at $1-5 each. Awwardly handles payment processing, receipts, and reporting. Organizations typically generate 60% of revenue from paid voting.',
      ...
      '## Ticket Sales\n\nSell ceremony tickets directly through Awwardly. Support early bird, VIP, and group pricing. Integrated check-in and badge printing.',
      '## Merchandise\n\nSell branded merchandise through your award hub. Awwardly integrates with major print-on-demand services.',
  ...
  },
  {
    ...
    content: [
      ...
      '## Consider Audience Voting vs. Judge Scoring\n\nSome categories work better with public voting (fan favorites) while others need expert judging (technical excellence). Awwardly supports both.',
    ],
  },
  {
    slug: 'judge-management-complete-guide',
    title: 'Judge Management: The Complete Guide',
    description: 'Everything you need to know about recruiting, managing, and scoring with judges on Awwardly.',
    ...
    content: [
      ...
      '## Recruiting Judges\n\nTarget industry leaders, past winners, and respected professionals. Awwardly provides a judge invitation system with custom messaging.',
      '## Scoring Criteria\n\nDefine clear criteria for each category. Awwardly supports weighted scoring, rubrics, and custom evaluation forms.',
      '## Conflict of Interest\n\nAwwardly automatically detects conflicts when judges have relationships with nominees. Judges can self-recuse with one click.',
      '## Transparency\n\nDecide how much scoring data to publish. Awwardly supports full transparency, aggregated scores, or winner-only disclosure.',
    ],
  },
  {
    slug: 'anti-fraud-security-guide',
    title: 'Vote Security & Anti-Fraud',
    description: 'How Awwardly protects the integrity of your voting process with enterprise-grade security measures.',
    ...
    content: [
      'Vote integrity is paramount. Awwardly employs multiple layers of security to ensure every vote counts fairly.',
  ...
  },
  {
    ...
    description: 'How to use Awwardly\'s analytics dashboard to understand engagement, optimize campaigns, and prove ROI to sponsors.',
    ...
    content: [
      'Data-driven decisions separate good award programs from great ones. Awwardly\'s analytics suite provides actionable insights at every stage.',
...
export const videos: Video[] = [
  {
    ...
    description: 'A complete walkthrough of creating your first award event on Awwardly, from basic settings to advanced configuration.',
    youtubeVideoId: 'dQw4w9WgXcQ',
    duration: '12:34',
    instructor: 'Awwardly Team',
  ...
  },
  {
    ...
    description: 'Leverage Awwardly\'s social features to build community and drive engagement during your event.',
    youtubeVideoId: 'dQw4w9WgXcQ',
    duration: '14:30',
    instructor: 'Michael Torres',
    instructorAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=100',
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    solution: 'Implemented Awwardly\'s hybrid voting system with public voting (60%) and judge scoring (40%), combined with enterprise-grade anti-fraud measures.',
  ...
  },
  {
    ...
    solution: 'Migrated to Awwardly\'s fully digital platform with automated nomination workflows, real-time voting, and instant results calculation.',
  ...
  },
  {
    ...
    solution: 'Used Awwardly\'s judge management system with 50+ industry experts, transparent scoring criteria, and a public nomination process.',
  ...
  },
  {
    ...
    solution: 'Deployed Awwardly with multi-language support, regional categories, and a combination of peer voting and manager scoring.',
...
export const bestPractices: BestPractice[] = [
  ...
  { slug: 'managing-judges-effectively', title: 'Managing Judges Effectively', description: 'Best practices for recruiting, briefing, and coordinating your judging panel.', tips: ['Recruit judges 2-3 months before scoring begins', 'Provide clear criteria and scoring rubrics', 'Set expectations for response times', 'Use Awwardly\'s conflict detection system', 'Send regular reminders during the scoring window'], category: 'best-practices' },
  { slug: 'preventing-vote-fraud', title: 'Preventing Vote Fraud', description: 'How to maintain voting integrity while keeping the process accessible.', tips: ['Enable device fingerprinting in Awwardly settings', 'Set reasonable rate limits (e.g., 5 votes per category per day)', 'Monitor real-time analytics for suspicious patterns', 'Require account verification for high-stakes categories', 'Publish your anti-fraud policy for transparency'], category: 'best-practices' },
...
export const faqs: FAQ[] = [
  { question: 'How do I create an award on Awwardly?', answer: 'Navigate to your dashboard and click "Create Event." Follow the step-by-step wizard to set up your categories, nomination rules, voting configuration, and ceremony details. The entire process takes about 15-20 minutes.', category: 'documentation' },
  { question: 'How does voting work on Awwardly?', answer: 'Awwardly supports multiple voting models: public voting (anyone can vote), judge-only scoring, and hybrid models. You can configure rate limits, voting windows, and anti-fraud measures for each category.', category: 'best-practices' },
  { question: 'Can I monetize my awards?', answer: 'Yes! Awwardly supports paid voting campaigns ($1-5 per vote), sponsor packages with tiered benefits, ticket sales, merchandise, and data insights packages. Most organizers generate revenue from multiple streams.', category: 'monetization' },
  { question: 'How do judges score nominees?', answer: 'Judges access a dedicated scoring portal where they evaluate nominees against your predefined criteria. Awwardly supports weighted scoring, rubrics, and automatic aggregation. Scores are kept confidential until you choose to publish.', category: 'documentation' },
  { question: 'How do I invite sponsors?', answer: 'Create sponsor packages in your dashboard with tiered benefits (logo placement, speaking slots, booth space, VIP access). Share the sponsorship prospectus directly from Awwardly or export it as a PDF.', category: 'monetization' },
  { question: 'Is voting secure on Awwardly?', answer: 'Absolutely. Awwardly uses device fingerprinting, rate limiting, CAPTCHA challenges, and machine learning-based fraud detection. Every vote is logged with a complete audit trail. We maintain a 0% fraud rate across all events.', category: 'security' },
  { question: 'Can I customize the look of my award hub?', answer: 'Yes! Upload your brand logo, set custom colors, add banners, and even use a custom domain. Awwardly\'s branding tools ensure your award hub matches your organization\'s identity.', category: 'documentation' },
  { question: 'What analytics are available?', answer: 'Awwardly provides real-time analytics including vote counts, voter demographics, engagement metrics, category performance, referral sources, and campaign ROI. Export PDF reports for sponsors and stakeholders.', category: 'analytics' },
  ...
  { question: 'Can I integrate Awwardly with other tools?', answer: 'Awwardly offers webhooks, API access, and integrations with popular tools like Mailchimp, Zapier, Google Analytics, and social media platforms. More integrations are added regularly.', category: 'api' },
];
